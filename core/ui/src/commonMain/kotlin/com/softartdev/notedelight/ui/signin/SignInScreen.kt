...
fun SignInScreen(signInViewModel: SignInViewModel) {
    ...
    DisposableEffect(key1 = signInViewModel, key2 = autofillManager) {
        autofillManager?.let(signInViewModel::attachAutofillManager)
        onDispose(signInViewModel::detachAutofillManager)
    }
