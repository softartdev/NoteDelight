...
import notedelight.core.ui.generated.resources.confirm_password_dialog_subtitle
...
fun ConfirmPasswordDialog(confirmViewModel: ConfirmViewModel) {
    ...
    DisposableEffect(key1 = confirmViewModel, key2 = autofillManager) {
        autofillManager?.let(confirmViewModel::attachAutofillManager)
        onDispose(confirmViewModel::detachAutofillManager)
    }
