...
import notedelight.core.ui.generated.resources.enter_password_dialog_subtitle
import notedelight.core.ui.generated.resources.enter_password_dialog_title
...
fun EnterPasswordDialog(enterViewModel: EnterViewModel) {
    ...
    DisposableEffect(key1 = enterViewModel, key2 = autofillManager) {
        autofillManager?.let(enterViewModel::attachAutofillManager)
        onDispose(enterViewModel::detachAutofillManager)
    }
