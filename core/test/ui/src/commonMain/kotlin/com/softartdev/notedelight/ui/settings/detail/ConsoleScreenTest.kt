...
abstract class ConsoleScreenTest {

    open fun tipsMenuShowsCopyAndAutofillBody(): TestResult = runComposeUiTest {
    ...
    open fun tipsMenuCopyActionBody(): TestResult = runComposeUiTest {
        setContent {
    ...
    open fun runButtonDisabledWhenInputBlankBody(): TestResult = runComposeUiTest {
        setContent {
    ...
    open fun inputFieldShowsAutofillValueBody(): TestResult = runComposeUiTest {
        setContent {
